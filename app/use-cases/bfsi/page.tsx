    ...
    <>
      ...
      <main className="min-h-screen bg-bg-pure">
        ...
        <UseCasePricing
          ...
          sub="Add the whole branch and DSA desk without the bill climbing seat by seat. Priced by team size and active-lead volume, 14-day free trial, no card, ~17% off on annual."
        />
