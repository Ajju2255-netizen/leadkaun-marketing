    ...
    <>
      ...
      <main className="min-h-screen bg-bg-pure">
        ...
        <UseCasePricing
          ...
          sub="Add the whole site team without the bill climbing seat by seat. Priced by team size and active-lead volume, 14-day free trial, no card, ~17% off on annual."
        />
