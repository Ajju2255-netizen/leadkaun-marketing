  ...
  return (
    <ComparePageLayout
      ...
      features={[
        ...
        { label: "Setup time",                                          leadkaun: "60 min",       competitor: "~1 day" },
      ]}
      pricing={{
      ...
      switching={[
        ...
        { title: "Onboard Leadkaun",    body: "60-minute wizard with a pre-configured ICP. Import the CSVs; Indian phones normalise on import." },
      ...
      faqs={[
        ...
        { q: "What does Leadkaun do that Bigin can't?", a: "Grade every lead A–F in under 500ms with intent decay, auto-rank each rep's queue in real time, and surface ₹-at-risk daily. Bigin records the pipeline; it doesn't decide priority for you." },
        { q: "Is migration hard?", a: "No. Bigin exports clean CSVs and Leadkaun ingests arbitrary columns as custom fields. The 60-minute onboarding handles ICP setup." },
