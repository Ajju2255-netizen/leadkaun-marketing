---
title: "How to Score and Prioritise EdTech Leads"
description: "EdTech lead scoring for Indian admissions teams: the exact fit, intent, and quality inputs that turn 300 daily leads into a queue of the 8–10 most likely to enrol."
date: "2026-05-20"
updated: "2026-06-13"
category: "edtech-sales"
pillar: 5
author: "Leadkaun"
tags: ["edtech", "lead-scoring", "admissions", "india"]
readingTime: "7 min read"
faqs:
  - q: "What is edtech lead scoring, exactly?"
    a: "It's a method for ranking inbound student leads by how likely they are to enrol, using three inputs: fit (does the programme, location, and budget match what you offer), intent (have they watched a demo, replied on WhatsApp, visited the page repeatedly, and how recently), and quality (is the phone number real, is the data complete). The output is a grade. A through F. That tells a counsellor who to call first."
...
Because intent decays, grades move. A B lead that replies on WhatsApp this afternoon climbs toward A. An A lead that goes silent for two weeks near a deadline slides. The grade is a live reading, not a stamp. See how the engine weights each input on the [lead scoring](/features/lead-scoring) page.

## From 300 leads to a queue of 8–10

Scoring is only half the job. The other half is what you *do* with the grades, and the answer is not "look at a dashboard and decide". It's a [Priority Queue](/features/priority-queue) that puts the right lead at the top of a counsellor's screen and tells them exactly who to call next.
...
This is the difference between a desk that drowns at 300 leads and one that closes more at 500. For a full picture of how scoring, the queue, and WhatsApp logging fit an admissions workflow, see the [edtech use case](/use-cases/edtech) and our deeper guide to [edtech student lead management in India](/blog/edtech-student-lead-management-india).
...
See it run on your own admissions funnel: [book a 15-minute demo](/demo) and watch your next 300 leads sort into a queue you can actually work.
