    ...
    <>
      ...
      <main className="min-h-screen bg-bg-pure">
        ...
        <UseCasePricing
          ...
          sub="Add the inside-sales desk and field reps without the bill climbing seat by seat. Priced by team size and active-lead volume, free forever tier, no card, ~17% off on annual."
        />
