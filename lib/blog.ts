...
export const CATEGORIES: BlogCategory[] = [
  {
    ...
    faqs: [
      ...
      { q: "What's a good lead response time in India?", a: "Faster than you think. Grade A leads convert at the highest rate when contacted within the hour; most Indian SMB teams average several hours to a day. The gap between those two is where the pipeline leaks — and it's measurable in rupees." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "What's the ideal follow-up time for a property enquiry?", a: "Inside the hour wherever possible — Grade A leads convert at the highest rate when contacted within the hour. For a ₹40 lakh–₹3 crore purchase, the builder who calls first and books the site visit usually wins, regardless of project." },
