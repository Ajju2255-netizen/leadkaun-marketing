    ...
    <>
      ...
      <main className="min-h-screen bg-bg-pure">
        ...
        <UseCasePricing
          ...
          sub="Add the whole calling floor and every centre without the bill climbing seat by seat. Priced by team size and active-lead volume, free forever tier, no card, ~17% off on annual."
        />
